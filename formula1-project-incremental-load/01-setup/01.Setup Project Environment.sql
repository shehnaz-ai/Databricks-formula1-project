...
-- MAGIC %md
-- MAGIC # Set-up the project environment for Formula1-incr Project
...
-- MAGIC %fs ls 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/landing'
...
CREATE EXTERNAL LOCATION IF NOT EXISTS databricks_course_ext_dl321_formula1_incr
URL 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/'
...
CREATE CATALOG IF NOT EXISTS formula1_incr
   MANAGED LOCATION 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/' 
...
CREATE SCHEMA IF NOT EXISTS formula1_incr.bronze
    MANAGED LOCATION 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/bronze';
CREATE SCHEMA IF NOT EXISTS formula1_incr.silver
    MANAGED LOCATION 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/silver';
CREATE SCHEMA IF NOT EXISTS formula1_incr.gold
    MANAGED LOCATION 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/gold';         
...
LOCATION 'abfss://formula1-incr@databrickscourseextdl321.dfs.core.windows.net/landing';
