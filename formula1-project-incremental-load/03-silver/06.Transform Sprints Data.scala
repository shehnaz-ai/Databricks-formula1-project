...
val bronze_table = catalog_name+"."+ bronze_schema + ".sprints"
val silver_table = catalog_name+"."+ silver_schema + ".sprints"
...
println(sprints_df.count() - sprints_valid_df.count())
...
write_to_silver(sprints_final_df,silver_table,
