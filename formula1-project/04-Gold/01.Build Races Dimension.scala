...
val target_table = catalog_name + "." + gold_schema + ".dim_races"
...
val circuits_df = spark.table( catalog_name +"."+ silver_schema+".circuits")
val races_df = spark.table( catalog_name +"."+ silver_schema+ ".races")
